          ...
          \begin{center}
              \begin{figure}[H]
                  ...
                  \fbox{
                      ...
                      \includegraphics[width=0.9\textwidth]{images/insert-two-pic.jpg}
                  }
                  \caption{并排插入两个图片的效果}
...
参考：\href{https://zhuanlan.zhihu.com/p/56435541}{LaTeX入门(八)——图片}


有时候我们的图片会显示的过大。但是图片会按照左边距进行开始排版，这会导致排版偏右，甚至超出界面。参考图\ref{Fig:VScode_with_latex_demo}，我们可以看到这个图占用比较多的空间。左边已经超出了左边界。但是这样看起来会好很多。
