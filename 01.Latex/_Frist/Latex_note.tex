...
参考链接：\href{https://blog.csdn.net/chichoxian/article/details/52588833}{\LaTeX 中插图总结}
...
\end{figure}
    ...
    \item begin\{figure\}[H] 这个H 参数，可以设置为以下几个，H为当前位置，!htb为忽略美学标准，htbp为浮动图形。 这个参数具体是怎么回事，什么原理，后面在讲解。
    % todo 浮动讲解
\end{enumerate}
