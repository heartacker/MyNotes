...
在线表格工具：\href{https://tableconvert.com/?output=latex}{在线表格工具}
\label{ref:table_of_generate}

在线表格工具：\href{https://www.tablesgenerator.com/}{在线表格工具2}
...
入门注意事项： \href{https://blog.csdn.net/simple_the_best/article/details/51244631}{\LaTeX{} 实战经验：新手须知}
...
我们使用宏 diagbox 进行分割。 只要将 diagbox 占用某个单元格即可。 分割几个，我们就传入几个表头。 顺序按照顺时针进行添加。 如实例 \ref{tab:div_cell} 中的 \verb!\diagbox{Time}{Room}{Day}!。
