...
如果有命令“和环境”的使用示例，那么LATEX包的文档就更容易读懂。最好的方法是对LATEX代码和格式化输出进行比较。
...
\begin{LTXexample}
    This is \small{small} and \Large{Large}!
\end{LTXexample}
...
\begin{LTXexample}
    This is {\zihao{6} 六号} and {\zihao{0} 大号}!
\end{LTXexample}
