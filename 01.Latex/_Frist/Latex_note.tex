...
% 定义一个颜色
\definecolor{codebg}{RGB}{250,240,235}
...
\begin{enumerate}
    ...
    \item \Checkmark 在需要的写入中文就好。
          ...
          \begin{minted}[frame=lines, bgcolor=codebg, linenos]{latex}
...
\begin{minted}[frame=lines, bgcolor=codebg, linenos]{shell}
...
\begin{minted}[frame=lines, bgcolor=codebg, linenos]{json}
...
% *\subsection{如果创建对比和渲染效果的"example" 环境?}
\subsection{如果创建对比和渲染效果的 "example" 环境?}
...
英文文中。使用 \verb!$\ldots$!。如： i$\ldots$you.

英文句尾，使用 \verb!\ldots!。如： i amd you \ldots.
...
% *\subsection{颜色}
\subsection{颜色}
多彩的世界，确实五彩斑斓的渲染。 参考： \href{https://www.overleaf.com/learn/latex/Using\_colours\_in\_LaTeX}{xcolor的教学}
